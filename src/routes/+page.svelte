...
<div class={`flex min-h-screen w-full flex-wrap justify-center ${gameState !== "guessing" ? "font-['ComicSansMSWeb',cursive]" : ""}`}>
	<div class="m-4 flex max-w-3xl flex-col">
		...
		{:else if gameState === 'win' || gameState === 'loss'}
			...
			<div class="mt-1">
				{#if img !== null}
					<img
						class="my-2 h-64 border border-white p-2 sm:float-none md:float-right md:m-2"
						src={img}
